...
<%
    //单点综合管理平台--新闻管理
    BaseBean.writeLog("----------单点综合管理平台--新闻管理--开始----------");
    ...
    BaseBean.writeLog("----------单点综合管理平台--新闻管理--结束----------");
%>
        ...
        if(!flag){
            ...
            jQuery.ajax({
                ...
                success:function(data){
                    ...
                    //跳转地址
                    window.location.href="http://172.18.102.69/imp/new/index_new.html?tokenId="+tokenId+"&userId="+userId+"&username="+username+"&memoName="+memoName;
                },
                error:function(data){
                    alert('用户名或密码不正确');
                    window.location.href="/spa/integration/static4engine/engine.html#/main/integration/accountSetting";
