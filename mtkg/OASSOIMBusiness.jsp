...
<%
    //单点综合管理平台--经营管理
    BaseBean.writeLog("----------单点综合管理平台--经营管理--开始----------");
    ...
    BaseBean.writeLog("----------单点综合管理平台--经营管理--结束----------");
%>
        ...
        if(!flag){
            ...
            jQuery.ajax({
                ...
                success:function(data){
                    ...
                    var memoName = JSON.stringify(data.user.memoName);
                    memoName = encodeURI(encodeURI(memoName));
                    ...
                    //跳转地址
                    window.location.href="http://172.18.102.69/imp/economicsment/index_cxgs.html?tokenId="+tokenId+"&userId="+userId+"&username="+username+"&memoName="+memoName;
                },
                error:function(data){
                    alert('用户名或密码不正确');
                    window.location.href="/spa/integration/static4engine/engine.html#/main/integration/accountSetting";
